...
public class ListDiscoverViewComponent : ViewComponent
{
    private readonly AppDbContext _context;
    private readonly UserManager<AppUser> _userManager;


    public ListDiscoverViewComponent(AppDbContext context, UserManager<AppUser> userManager)
    {
        _context = context;
    ...
    public async Task<IViewComponentResult> InvokeAsync()
    {
        ...
        var listsToFollow = lists.Where(l => !l.IsDeleted)
                                 .Where(l => !followedListIds.Contains(l.Id)).Take(3).ToList();
